...
def seven_seg_SR(toDisplay,option="decimal"):
    """
    :param toDisplay: enter message to be displayed
    :param option: enter "decimal" if message has a decimal point. Default is None
    """
    if option=="decimal":
...
def run_seven_seg(display):
    '''
    Run seven seg without scrolling
...
def run_seven_seg_scroll(display,duration):
    '''
    Run seven seg display with scrolling
    :param display: enter a 4 digit alphanumeric phrase
